...
<script type="text/javascript">
	...
	$(function () {
		...
		$("#saveCreateActivityBtn").click(function () {
			...
			/*
			正则表达式：定义字符串的匹配模式，可以用来判断指定的具体字符串是否符合字符串的匹配模式
			 */
			var regExp = /^(([1-9]\d*)|0)$/;
			if (!regExp.test(cost)) {
				alert("成本只能为非负整数");
			...
			$.ajax({
				...
				success: function (data) {
					if (data.code = "1") {
						...
						var rowsPerPage = $("#demo_pag1").bs_pagination('getOption', 'rowsPerPage');
						queryActivityByConditionForPage(1, rowsPerPage);
					} else {
						//提示信息
						alert(data.message);
						//模态窗口不关闭 可以不写此语句
		...
		$("#exportActivityXzBtn").click(function () {
			...
			var id = "?";
			// 遍历数组
			$.each(checkedIds, function () { // id的格式为：id=xxx&id=xxx&id=xxx&id=xxx&id=xxx..
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control mydate" id="edit-startDate" >
							</div>
							<label for="edit-endDate" class="col-sm-2 control-label">结束日期</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control mydate" id="edit-endDate" >
							</div>
						</div>
